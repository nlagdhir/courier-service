...
export default function BookingSearchResult({ booking, handleEdit }) {
  return (
    <section className="md:w-3/5 border-t-4 border-blue-400 bg-blueGray-50">
      <div className="flex-auto px-4 lg:px-5  py-4 pt-0 bg-white">
        ...
        {booking
          ...
          ?.map((book) => (
            <div
              key={book.id}
              className="md:flex items-center border-b-2 mt-3 border-gray-300 pb-2 "
            >
              <div className="mr-4">
              ...
              <div className="md:w-3/5">
                <p className="uppercase text-sm">
                  <span className="text-purple-500 font-semibold pr-2">
                    {book?.sender}
                  </span>
                  <span className="font-semibold">{book?.center}</span>
                </p>
              ...
              <div className="flex items-center mt-4 mb-2">
                <div className="flex justify-start md:justify-center items-center pr-10">
