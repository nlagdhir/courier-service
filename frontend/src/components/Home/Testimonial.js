  ...
  return (
    <section className=" body-font">
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-4xl font-medium title-font text-white mb-5 text-center">
          Testimonials
        </h1>
        <p className="text-2xl text-white font-bold flex py-4 justify-center items-center">
