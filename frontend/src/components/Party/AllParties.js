...
function AllParties({ handlePartyEdit, data, partyData }) {
  return (
    <div className="md:w-3/5">
      <div className="shadow-lg bg-white rounded border-t-4 border-blue-400 overflow-hidden md:ml-2">
          ...
          <table className="table">
            <thead>
              <tr className="bg-gray-100">
                <th className="w-1/5 md:w-1/4 py-4 px-3 text-sm text-left text-gray-600  font-semibold uppercase">
                  Name
                </th>
                <th className="w-1/5 md:w-1/4 py-4 px-3 text-sm text-left text-gray-600  font-semibold uppercase">
                  Contact
            ...
            <tbody className="bg-white">
              {partyData
                ...
                .map((d) => (
                  <tr key={d._id}>
                    <td className="py-4 text-sm px-3 border-b border-gray-200">
                      {d.name}
                    </td>
                    <td className="py-4 px-3 text-sm border-b border-gray-200 truncate">
                      {d.contactPerson}
                    </td>
                    <td className="py-4 px-3 text-sm border-b border-gray-200 truncate">
                      {d.email}
                    </td>
                    <td className="py-4 px-3 border-b text-xs border-gray-200">
                      {" "}
                      {d.mobile}
                    </td>
